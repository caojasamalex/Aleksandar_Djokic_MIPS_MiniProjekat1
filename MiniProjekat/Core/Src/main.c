...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  ...
	  // Prva sekvenca se ponavlja onoliko puta koliko ima slova u imenu - Aleksandar - 10
	  // Impuls ce imati trajanje od 10 ms - Broj slova u imenu
	  ...
	  // Nakon sto se zavrsi prva sekvenca, potrebno je zapoceti drugu sekvencu koja ima onoliko ponavljanja
	  // koliko ima slova u prezimenu
	  // Djokic - 5
